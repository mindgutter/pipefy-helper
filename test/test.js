...
var ORGANIZATION_ID, PIPE_ID, CLONE_PIPE_ID, PIPE_RELATION_ID, LABEL_ID, PHASE_ID, NEXT_PHASE_ID, PHASE_FIELD_ID, CARD_ID, COMMENT_ID;
...
describe('Pipefy', () => {
    ...
    describe('#createOrganization', () => {
        it('should return created organization data from API', async () => {
            var result = await pipefy.createOrganization({industry: 'technology', name: 'DONT DELETE'});
    ...
    describe('#createPipe', () => {
        it('should return created pipe from API', async () => {
            var result = await pipefy.createPipe({
    ...
    describe('#clonePipes', () => {
        it('should return success on clone pipe from API', async () => {
            var result = await pipefy.clonePipes({organization_id: ORGANIZATION_ID, pipe_template_ids: [PIPE_ID]});
    ...
    describe('#createPipeRelation', () => {
        it('should return created pipe relation from API', async () => {
            var result = await pipefy.createPipeRelation({
    ...
    describe('#createLabel', () => {
        it('should return created label from API', async () => {
            var result = await pipefy.createLabel({pipe_id: CLONE_PIPE_ID, name: 'My label', color: '#000000'});
    ...
    describe('#createPhase', () => {
        it('should return created phase from API', async () => {
            var result = await pipefy.createPhase({
    ...
    describe('#createPhaseField', () => {
        it('should return create phase field from API', async () => {
            var word = randomWord();
            var result = await pipefy.createPhaseField({
                phase_id: PHASE_ID,
                type: 'phone',
                label: word,
                description: word,
    ...
    describe('#createCard', () => {
        it('should return created card from API', async () => {
            var result = await pipefy.createCard({
                pipe_id: CLONE_PIPE_ID,
    ...
    describe('#createComment', () => {
        it('should return created comment from API', async () => {
            var result = await pipefy.createComment({card_id: CARD_ID, text: 'I added this comment'});
    ...
    describe('#getOrganizationById', () => {
        it('should return organization data by id from API', async () => {
            var result = await pipefy.getOrganizationById(ORGANIZATION_ID);
    ...
    describe('#getPipesByIds', () => {
        it('should return pipes data by ids from API', async () => {
            var result = await pipefy.getPipesByIds([PIPE_ID, CLONE_PIPE_ID]);
    ...
    describe('#getPipeById', () => {
        it('should return pipe data by id from API', async () => {
            var result = await pipefy.getPipeById(PIPE_ID);
    ...
    describe('#getPhaseById', () => {
        it('should return phase data by id from API', async () => {
            var result = await pipefy.getPhaseById(PHASE_ID);
    ...
    describe('#getCardsByPipeId', () => {
        it('should return cards data by pipe id from API', async () => {
            var result = await pipefy.getCardsByPipeId(PIPE_ID);
    ...
    describe('#getCardById', () => {
        it('should return card data by id from API', async () => {
            var result = await pipefy.getCardById(CARD_ID);
    ...
    it('should return pipe realtion by ids from API', async () => {
        var result = await pipefy.getPipeRelationByIds([PIPE_ID, CLONE_PIPE_ID]);
    ...
    it('should return updated organization data from API', async () => {
        var result = await pipefy.updateOrganization({
            id: ORGANIZATION_ID,
            name: 'Capsule Corp.',
    ...
    it('should return updated pipe from API', async () => {
        var result = await pipefy.updatePipe({
            id: CLONE_PIPE_ID,
            name: 'Cao Project',
    ...
    it('should return updated phase from API', async () => {
        var result = await pipefy.updatePhase({
            id: PHASE_ID,
...
describe('#updatePhaseField', async () =>  {
  it('should return updated phase field from API', async () =>  {
    var result = await pipefy.updatePhaseField({
      id: PHASE_FIELD_ID,
      label: 'Paid Value R$',
...
*/
    ...
    it('should return updated label from API', async () => {
        var result = await pipefy.updateLabel({id: LABEL_ID, color: '#000000', name: 'Changed Name Label'});
    ...
    it('should return updated card from API', async () => {
        var result = await pipefy.updateCard({
            id: CARD_ID,
            title: 'New Test Card',
    ...
    it('should return updated comment from API', async () => {
        var result = await pipefy.updateComment({id: COMMENT_ID, text: 'Edit: Im editing this comment'});
    ...
    it('should return updated pipe relation from API', async () => {
        var result = await pipefy.updatePipeRelation({
            id: PIPE_RELATION_ID,
    ...
    it('should return moved card from API', async () => {
        var card = await pipefy.getCardById(CARD_ID);
        var phase = await pipefy.getPhaseById(card.data.card._current_phase.id);
        NEXT_PHASE_ID = phase.data.cards_can_be_moved_to_phases[0].id;
        var result = await pipefy.moveCardToPhase({card_id: CARD_ID, destination_phase_id: NEXT_PHASE_ID});
    ...
    describe('#setRole', () => {
        it('should return member with new role from API', async () => {
            var result = await pipefy.setRole({
                pipe_id: CLONE_PIPE_ID,
                organization_id: ORGANIZATION_ID,
    ...
    describe('#deleteComment', () => {
        it('should return success on delete comment from API', async () => {
            var result = await pipefy.deleteComment(COMMENT_ID);
    ...
    describe('#deleteCard', () => {
        it('should return success on delete card from API', async () => {
            var result = await pipefy.deleteCard(CARD_ID);
    ...
    describe('#deletePhaseField', () => {
        it('should return success on delete phase field from API', async () => {
            var result = await pipefy.deletePhaseField(PHASE_FIELD_ID);
    ...
    describe('#deletePhase', () => {
        it('should return success on delete phase from API', async () => {
            var result = await pipefy.deletePhase(PHASE_ID);
    ...
    describe('#deleteLabel', () => {
        it('should return success on delete label from API', async () => {
            var result = await pipefy.deleteLabel(LABEL_ID);
    ...
    describe('#deletePipeRelation', () => {
        it('should return success on delete pipe relation from API', async () => {
            var result = await pipefy.deletePipeRelation(PIPE_RELATION_ID);
    ...
    describe('#deletePipe', () => {
        it('should return success on delete pipe from API', async () => {
            var result = await pipefy.deletePipe(CLONE_PIPE_ID);
